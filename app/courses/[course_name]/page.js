...
export default async function CourseDetails(context) 
{
  ...
  return (
    <>
      <main className="bg-bg-blue text-white font-Poppins flex flex-col gap-10 capitalize py-8 px-8 md:px-10 text-left sm:py-10 sm:px-14">
        <span className="flex flex-row flex-wrap items-center gap-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold capitalize">{courseData.title}</h1>
